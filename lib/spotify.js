...
export const getSongs = async (refresh_token, weather) => {
  ...
  //   return fetch(`https://api.spotify.com/v1/search?q=${weather}%20genre:classical&type=track&limit=10&offset=10`, {
  //     headers: {
  //       Authorization: `Bearer ${access_token}`
  //     }
  //   })
  // }
  return fetch(`https://api.spotify.com/v1/recommendations?limit=10&seed_artists=4NHQUGzhtTLFvgF5SZesLK&seed_genres=classical%2Ccountry&seed_tracks=0c6xIDDpzE81m2q797ordA`, {
    headers: {
      Authorization: `Bearer ${access_token}`
    }
  })
